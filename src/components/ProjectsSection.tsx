...
const projects = [
  {
    ...
    description:
      "Serves as the official online catalog of the library, showcasing digitized books and providing detailed information about the library. It's main feature is a seat reservation, allowing users to book available spots in the library with ease.",
